...
public class RubricaViewController implements Initializable {
   ...
   /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        BooleanBinding controlloNumero=Bindings.createBooleanBinding(()->(campoPrimoNum.getText().isEmpty() || campoPrimoNum.getText().matches("[\\d\\s]*")) && (campoSecondoNum.getText().isEmpty()  || campoSecondoNum.getText().matches("[\\d\\s]*")) && (campoTerzoNum.getText().isEmpty()  ||  campoTerzoNum.getText().matches("[\\d\\s]*")),campoPrimoNum.textProperty(),campoSecondoNum.textProperty(),campoTerzoNum.textProperty());
        BooleanBinding controlloEmail=Bindings.createBooleanBinding(()->(campoPrimaMail.getText().isEmpty()||campoPrimaMail.getText().contains("@") ) && ( campoSecondaMail.getText().isEmpty() || campoSecondaMail.getText().contains("@") ) && (campoTerzaMail.getText().isEmpty()||campoTerzaMail.getText().contains("@") ),campoPrimaMail.textProperty(),campoSecondaMail.textProperty(),campoTerzaMail.textProperty());
        pulsanteAggiungi.disableProperty().bind(controlloNumero.not().or((campiNonVuoti.not()).or(controlloEmail.not())));
